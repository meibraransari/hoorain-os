...
export class ImportService {
  ...
  private mapCashewIconToEmoji(iconName: string | null | undefined, catName: string = ''): string | undefined {
  ...
  private async importCategories(
    ...
    const entities = categories.map((c) => {
      ...
      return repo.create({
        ...
        icon: this.mapCashewIconToEmoji(c.emoji_icon_name ?? c.icon_name, c.name),
